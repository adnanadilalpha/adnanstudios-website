...
export const seedArticles: SeedArticle[] = [
  {
    ...
    description:
      'Zero Handoff is how Adnan Studios designs in Figma and ships in Next.js, Flutter, or WordPress under one roof. Here is why split design-and-dev agencies cannot replicate it.',
    publishedAt: '2026-01-15',
    paragraphs: [
      'Zero Handoff means the same studio that frames the product in Figma ships the production build — in Next.js, Flutter, or WordPress depending on what the product needs. There is no translation layer between a design file and a developer ticket.',
      ...
      'When one studio owns both sides, decisions happen faster. A layout choice in Figma maps directly to a React component, Flutter widget, or WordPress template. Spacing, motion, and edge cases get resolved by the same team that understood the user problem.',
      'Agencies rarely offer this because their margin model depends on billable roles. A unified design-and-build studio is harder to staff on a bench model and harder to sell in a line-item SOW.',
      'Zero Handoff is not "designer who codes a bit." It is full studio ownership from discovery through deployment. You get one accountable partner, one timeline, and one codebase that matches what was designed.',
  ...
  },
  {
    ...
    paragraphs: [
      'Every project starts with scope, not screens. Our studio defines the user job, success metric, and platform constraints before opening Figma. That includes choosing the right stack: Next.js for web apps and marketing sites, Flutter for cross-platform mobile, WordPress for content-heavy products.',
      'Wireframes come next. Low fidelity, fast iteration, shared with the client for alignment. Once the flow is approved, we build a component system in Figma that mirrors the production structure: atoms, molecules, screens.',
      ...
      'Launch includes store assets or hosting setup, analytics hooks, and a short post-launch window for fixes. Because our studio built it, we can patch production issues without waiting on another team to interpret a design file.',
    ],
  },
  {
    ...
    paragraphs: [
      ...
      'Share three reference products and one anti-reference. "I like the onboarding from X" and "I hate the density of Y" gives our studio direction without copying.',
      ...
      'Budget and timeline should be honest ranges, not anchors for negotiation. We can tell you what fits in four weeks versus eight. We cannot read your runway from silence.',
    ],
  },
  {
    ...
    paragraphs: [
      ...
      'Zero Handoff exists partly to remove the third leak. One studio, one quote, one timeline.',
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Both packages include Figma design and production build by Adnan Studios. The difference is depth, screen count, and support after launch.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Zero Handoff reduces this risk because one studio holds design and code. If you must switch, switch at a milestone with full export: Figma, repo access, decision log, and analytics baseline.',
      'The cheapest project is often the one that finishes with the same studio who started it.',
    ],
  },
]
